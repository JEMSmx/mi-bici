  ...
  <section class="k-section-80 contact">
      ...
      <div class="unit one-third">
        ...
        <div class="social-networks">
          <a href="https://www.facebook.com/MiBiciPublica" target="_blank" alt="Facebook MIBICI">
            <img src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/facebook.svg" alt="">
          </a>
          <a href="https://twitter.com/MiBiciPublica" target="_blank" alt="Twitter MIBICI">
            <img src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/twitter.svg" alt="">
          </a>
          <a href="http://instagram.com/mibicipublica" target="_blank" alt="instagram MIBICI">
            <img src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/instagram.svg" alt="">
          </a>
          <a href="https://www.youtube.com/user/MiBiciPublica/" target="_blank" alt="Youtube MIBICI">
            <img src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/youtube.svg" alt="">
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="grid customer-service">
      ...
      <div class="unit half">
        ...
        <p style="margin-top:15px;" class="k-sm">
        <?php echo __("L-V 8:00 hrs a 16:00 horas"); ?></p>
