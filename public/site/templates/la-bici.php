  ...
  <section class="k-section-80" style="margin-top:0;">
    <section class="main-product__showcase">
        ...
        <div class="k-showcase">
          <div class="k-showcase--item"  style="background-image:  url('<?php echo $config->urls->templates; ?>static/455375-147357/images/la-bicicleta-mibici.gif')">
        ...
        <div class="k-showcase-split-two">
          <div class="k-showcase-split-two--item k-showcase-image" style="background-image:  url('<?php echo $config->urls->templates; ?>static/455375-147357/images/numero-id.png')">
            <div class="k-showcase--item--color">
            </div>
          </div>
          <div class="k-showcase-split-two--item">
          ...
          <div class="k-showcase-split-two--item k-showcase-image-responsive" style="background-image:  url('<?php echo $config->urls->templates; ?>static/455375-147357/images/numero-id.png')">
            <div class="k-showcase--item--color">
            </div>
          </div>
        </div>
