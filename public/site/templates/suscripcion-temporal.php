<?php include("./_head.php"); ?>
  ...
  <article class="k-article">
    ...
    <p align="center"><img alt="" src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/degollado-for-susc-temp.jpg" style="max-width:100%"></p>
    ...
    <div class="vertical-split">
      ...
      <div>
        <img alt="" src="<?php echo $config->urls->templates; ?>static/455375-1495356493/images/renta-bici-2.gif">
      </div>
    </div>
